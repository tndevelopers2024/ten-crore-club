  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5 rounded-xl border border-line bg-ink-card p-6 sm:p-8" noValidate>
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-xl bg-red-mid px-6 py-3.5 font-medium text-on-accent transition-colors hover:bg-red-vivid disabled:opacity-70"
      >
